...
if '/mnt/host_root/home/jovyan/winstonxcai/flash-optimizations' not in _sg_lr_sys.path:
    _sg_lr_sys.path.insert(0, '/mnt/host_root/home/jovyan/winstonxcai/flash-optimizations')
