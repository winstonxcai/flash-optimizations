#!/usr/bin/env bash
# Watchdog for the hard-task NATIVE-CSA control run. Polls every 600s.
...
WATCH_LOG=/home/jovyan/winstonxcai/flash-optimizations/mustafar/logs/hardnative_watchdog.log
