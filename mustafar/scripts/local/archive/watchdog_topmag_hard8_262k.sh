#!/usr/bin/env bash
# Watchdog for the TopMag50 @262144 8-hard rerun. Polls every 600s.
...
WATCH_LOG=/home/jovyan/winstonxcai/flash-optimizations/mustafar/logs/topmag_hard8_262k_watchdog.log
