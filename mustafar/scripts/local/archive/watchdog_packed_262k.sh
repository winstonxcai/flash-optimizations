#!/usr/bin/env bash
# Watchdog for the Stage-1 PACKED @262144 25-task run (two servers 30211+30212).
# Polls every 600s.
...
WATCH_LOG=/home/jovyan/winstonxcai/flash-optimizations/mustafar/logs/packed_262k_watchdog.log
