...
# Serving the OFFICIAL 0731 checkpoint (deepseek-ai/DeepSeek-V4-Flash-0731),
# which ships fp4-packed experts (I8 containers + ue8m0 scales). SGLANG_DSV4_FP4_DEQUANT=1
# makes the runtime cast fp4 -> fp8 at load (cast_e2m1fn_to_e4m3fn, value-preserving)
# so the rest of the fp8-triton packed stack runs exactly as on the pure-fp8 repack.
...
LOG=/mnt/host_root/home/jovyan/winstonxcai/flash-optimizations/mustafar/logs/serve_packed_graph_tp8_500k_bs8_30211_0731.log
...
nohup python3 -m sglang.launch_server \
  ...
  > "$LOG" 2>&1 &
echo "launched packed-graph tp8 bs8 (0731) pid $!"
