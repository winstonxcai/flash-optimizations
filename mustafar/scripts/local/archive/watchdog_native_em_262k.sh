#!/usr/bin/env bash
# Watchdog for the native @262144 easy+medium rerun (30212/0-3). Polls every 600s.
...
WATCH_LOG=/home/jovyan/winstonxcai/flash-optimizations/mustafar/logs/native_em_262k_watchdog.log
