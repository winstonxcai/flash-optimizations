#!/usr/bin/env bash
# Watchdog for the 25-distinct-task TopMag50-on-native-c4 eval
# (run_topmag50_25d.sh). Polls every 10 min: server 30211 alive, per-task
# progress, ALL_25_DONE marker.
#   exit 0 = all 25 done (writeup time)
#   exit 2 = server 30211 died (relaunch + resume needed)
#   exit 3 = 48h cap hit
set -u
WATCH_LOG=/home/jovyan/winstonxcai/flash-optimizations/mustafar/logs/eval25d_watchdog.log
