...
def provenance():
    ...
    sources = [root / name for name in (
        "remnant/cuda/fused/fused.cu", "remnant/tests/reconstruction.py",
        "remnant/tests/harness.py", "remnant/tests/speed.py")]
    info = {
...
def run(*, action="timing", batches=(15, 18, 21), modes=MODES, samples=500, rounds=3):
    ...
    directory = Path(os.environ.get("REMNANT_RESULTS_DIR", "."))
