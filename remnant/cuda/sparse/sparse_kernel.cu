...
using remnant::packed::kHeadDim;
using remnant::packed::kKeptValues;
using remnant::packed::kBitmapWords;
using remnant::packed::kNopeDim;
using remnant::packed::kRopeDim;
