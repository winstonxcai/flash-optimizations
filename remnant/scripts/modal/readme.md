...
Results are committed after every point to `remnant-packed-results`:

```bash
modal volume get remnant-packed-results tp4-capacity-ceiling.json ./results/
modal volume get remnant-packed-results official-capacity ./results/
modal volume get remnant-packed-results capacity-topmag50_packed-server.log ./results/
modal volume get remnant-packed-results capacity-native-server.log ./results/

modal volume get remnant-packed-results tp4-graph-decode-ab.json ./results/
modal volume get remnant-packed-results official-graph-decode ./results/
modal volume get remnant-packed-results graph-decode-topmag50_packed-server.log ./results/
modal volume get remnant-packed-results graph-decode-native-server.log ./results/
```
...
| Remnant Packed commit | `abd18764701eb4db9586a664a1b042c0acb89cd1` |
...
```bash
modal volume get remnant-packed-results packed-report-untouched.json ./results/
modal volume get remnant-packed-results packed-report-untouched-raw ./results/
modal volume get remnant-packed-results packed-report-untouched-untouched.log ./results/
```

Final result files:

```bash
modal volume get remnant-packed-results packed-report-native.json ./results/
modal volume get remnant-packed-results packed-report-packed.json ./results/
```
